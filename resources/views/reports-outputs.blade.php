...
@section('content')
    <div class="container">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="filter-type-selector" id="filter-type-selector" class="custom-select">
                                ...
                                <option value="part">محل مصرف</option>
                                <option value="worker">خارج کننده</option>
                            </select>
                        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('گزارش خروج') }}
                        <button id="view-report" class="btn btn-outline-secondary btn float-left">مشاهده گزارش</button>
                    </div>

                    <div class="card-body">

                        <form id="filtersForm" action="{{ route('reports.outputs.show') }}" method="post">

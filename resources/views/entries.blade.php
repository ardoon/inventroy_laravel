...
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="new-entry" method="post" action="{{ route('entries.store') }}">
                            <div class="form-group row">
                                ...
                                <div class="form-group col-4">
                                    <button id="submit" class="btn btn-outline-secondary w-50 float-left ml-3 mt-3">ثبت
                                        ورود به انبار
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="form-group row custom-single-product">
                                ...
                                <div class="form-group col-1">
                                    ...
                                    <select class="custom-select custom-select-sm" id="special" name="special[]" required>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#new-entry").on("click", "custom-single-product", function() {
                let $tr = $(this);
                let myRow = $("#new-entry custom-single-product").index($tr);
                console.log(myRow);
            });
